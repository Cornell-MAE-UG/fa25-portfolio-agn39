...
Pre Mesh Refinement
![image here]({{ site.baseurl }}/assets/images/stresspre.png)
Post Mesh Refinement
![image here]({{ site.baseurl }}/assets/images/stresspost.png)

**Figure 8: Load Point Deflection (Directional)**

Pre Mesh Refinement
![image here]({{ site.baseurl }}/assets/images/deflectionpre.png)
Post Mesh Refinement
![image here]({{ site.baseurl }}/assets/images/deflectionpost.png)

**Figure 9: Maximum Strain Values Over Time** 

Pre Mesh Refinement
![image here]({{ site.baseurl }}/assets/images/gaugepre.png)
Post Mesh Refinement 
![image here]({{ site.baseurl }}/assets/images/gaugepost.png)
...
Reducing the mesh allowed us to see more accurate values of strain, stress, and deflection over the geometry of the wrench. Below is a comparison of the mesh size (0.25/0.06 in --> 0.1/0.02 in)

**Figure 11: Mesh Comparison Pre and Post Refinement**
